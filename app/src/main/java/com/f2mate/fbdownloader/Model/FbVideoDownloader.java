package com.f2mate.fbdownloader.Model;
...
import com.f2mate.fbdownloader.Interfaces.VideoDownloader;
...
public class FbVideoDownloader implements VideoDownloader {
    ...
    public FbVideoDownloader(Context homeFragment, String url) {
    ...
    public String createDirectory() {
        ...
        if (!folder.exists()) {
            ...
            subFolder = new File(folder.getPath()+File.separator);
            if(!subFolder.exists())
            {
        ...
        protected void onPostExecute(String s)
        {
            if(!s.contains("No URL")) {
                ...
                try {
                    ...
                    Toast.makeText(context, "Downloading Failed,try another link", Toast.LENGTH_SHORT).show();
                }
