...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerViewAdapter.ViewHolder holder, final int position)
    {
        ...
        holder.userName.setText(files.getFilename());
        // check size from video
        long size = file.length();
        if(size <= 0){
        }else {
            final String[] units = new String[] { "B", "kB", "MB", "GB", "TB" };
            int digitGroups = (int) (Math.log10(size)/Math.log10(1024));
            holder.videoSize.setText(new DecimalFormat("#,##0.#").format(size/Math.pow(1024, digitGroups)) + " " + units[digitGroups]);
        }//check size from video end
        ...
        holder.deleteID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PopupMenu popup = new PopupMenu(context, holder.deleteID);
                popup.inflate(R.menu.menu_recy);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            deleteID = (TextView) itemView.findViewById(R.id.deleteID);
        }
    }
}
